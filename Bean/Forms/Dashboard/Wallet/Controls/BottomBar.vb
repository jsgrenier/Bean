Public Class BottomBar
    ...
    End Sub
    Private Sub MainPanel_MouseEnter(sender As Object, e As EventArgs) Handles MainPanel.MouseEnter, Label1.MouseEnter, PBArrow.MouseEnter
    ...
    End Sub
    Private Sub MainPanel_MouseLeave(sender As Object, e As EventArgs) Handles MainPanel.MouseLeave, Label1.MouseLeave, PBArrow.MouseLeave
    ...
    Private Sub MainPanel_MouseClick(sender As Object, e As MouseEventArgs) Handles MainPanel.MouseClick, Label1.MouseClick, PBArrow.MouseClick
